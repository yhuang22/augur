...
3. Create a new file named `augur.config.json` and add your GitHub API key to it.
...
make dev
```
To view the UI, use the link generated by the command `make dev`, it will look something like 'http://localhost:3333'.
